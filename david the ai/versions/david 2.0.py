...
response_dict = {
    ...
    "what is planned for you": ["as an ai that has no idea when my iq grows i have no idea and if i knew i wouldnt tel you"],
...
def main():
    ...
    print("updates: software 2.0 more inputs")
    print("david: hi")
    while True:
