...
response_dict = {
    ...
    "what is planned for you": ["as an ai that has no idea when my iq grows i have no idea and if i knew i wouldnt tell you"],
    "i have an idea for you": ["if you have an idea dont tell me email erplays238@gmail.com"],
    "im going insane": ["get therapy"],
    "can you tell me what i can run you on": ["your running me right now stupid"],
    "what do i do when im sick": ["im not even real so i dont know"],
...
def chatbot(input_text):
    ...
    return "its a typo or that input doesnt exist"
...
def main():
    ...
    print("updates: software 2.1 fixed typos")
    print("david: hi")
    while True:
