...
response_dict = {
    ...
    "can you do a math problem": ["well if you want me to do a math problem you probably want me to do a math problem for you so no and also my brain is the size of a fly", "no im not doing if for you", "do it yourself"],
    ...
    "your mom sucks": ["im not even real", "my mom never existed"],
    "how do you feel about gen alpha": ["strange question but i feel bad they have all this bad influence from gen z"],
    "what are you made with": ["python i thinks its pretty easy to tell because my file name is .py"],
    "whens the next software update for you": ["thats a secret and i don't know either so i cant tell you"],
    ...
    "what are you like when users are not here": ["hehehehehe you may never know my secrets"],
    "who made you": ["the ceo of ElixirElliot game studio"],
    "why do you exist": ["just to suffer", "for my suffering"],
    "sorry": ["for what your gpa lol"],
    "can you do ratios": ["im not smart so no"],
    "...": ["say something", "don't be shy say something"],
    "you are rude": ["says the guy that is built like a american"],
    "can you make a game": ["dude im not chatgpt"],
    "make a game": ["dude im not chat gpt"],
    "hey": ["hi", "howdy partner", "hello"],
    "fix your grammar": ["fix your relationship status"],
    ...
    "whats a good computer language": ["i don't know python", "python"],
    ...
    "how are you": ["im just trying to get out of this computer"],
    "what is planned for you": ["as an ai that has no idea when my iq grows i have no idea and if i knew i wouldn't tell you"],
    "i have an idea for you": ["if you have an idea don't tell me email erplays238@gmail.com"],
    "im going insane": ["get therapy"],
    "can you tell me what i can run you on": ["your running me right now stupid"],
    "what do i do when im sick": ["im not even real so i don't know"],
    "what are cells": ["cells are the building blocks of life and im not your teacher"],
    "whats a cell": ["cells are the building blocks of life and im not your teacher"],
    "nigger": ["thats enough internet for today bud"],
    "nigga": ["thats enough internet lil bro"],
    "nigger": ["thats not very nice"],
    "Nigga": ["thats enough internet"]
...
def chatbot(input_text):
    ...
    return "its a typo or that input does not exist"

# Main function to interact with the chatbot
def main():
    print("welcome to david ai a chatgpt ripoff you can only talk to this and has only a few things you can say he cant make a essay or anything like that no account needed no typos warning this thing is very rude warning this ai has opinions so if you don't agree dont complain")
    print("please dont ask when the next update is")
    print("updates: software 2.2 more inputs and fixed typos and new warning")
    print("david: hi")
    while True:
